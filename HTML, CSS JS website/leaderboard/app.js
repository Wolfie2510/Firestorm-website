...
function sortTable(column, sort_asc) {
    const sorted_rows = Array.from(table_rows).sort((a, b) => {
    ...
    sorted_rows.forEach(sorted_row => document.querySelector('tbody').appendChild(sorted_row));
}
...
function addRow() {
    ...
    newRow.innerHTML = `
        ...
        <td><input type="text" placeholder="Rank"></td>
